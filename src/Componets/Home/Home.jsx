...
function Home() {
  ...
  return (
    <>
      ...
      <hr />
      <div className="analytics mt-8 flex flex-wrap relative left-1/4 w-1/2  justify-center items-center text-center border-gray-600 border-solid border-2 bg-stone-100 rounded-lg">
        <div className="text-block mt-5">
          <span className="font-bold text-6xl pl-8 border-solid border-r-2 border-gray-600 pr-3 text-blue-600">300K+</span>
          <p>companies hiring</p>
        </div>
        <div className="text-block mt-5">
          <span className="font-bold text-6xl pl-8 border-solid border-r-2 border-gray-600 pr-3 text-blue-600">10K+</span>
          <p>new openings everyday</p>
        </div>
        <div className="text-block mt-5">
          <span className="font-bold text-6xl pl-8 border-solid border-r-2 border-gray-600 pr-3 text-blue-600">21Mn+</span>
          <p>active students</p>
        </div>
        <div className="text-block mt-5">
          <span className="font-bold text-6xl pl-8  text-blue-600">600K+</span>
          <p>learners</p>
        </div>
      </div>
